     ...
     const SearchTextTitle(title:'Top Searches',),
        ...
        Expanded(
          child: ListView.separated(
            shrinkWrap: true,
            itemBuilder: (ctx,index)=> TopSearchIthemTile(url:  popular[index].imagePath,
                    movieName: popular[index].title), separatorBuilder: (ctx,index)=> kheight, itemCount:popular.length ),
        )
      ],
    );
  }
